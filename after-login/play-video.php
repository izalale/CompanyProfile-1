 ...
 <link rel="stylesheet" href="/contoh/foodizz/front/css/responsive.css">
    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbar-main">
            ...
            <div class="header-content classdetail">
        <div class="container">
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <div class="embed-responsive embed-responsive-16by9">
                               <iframe width="560" height="315" src="https://www.youtube.com/embed/TVt_dsGnZfw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>
...
<script>
    function updateStats(content_id) {
        ...
        $.ajax({
            ...
            url: 'https://foodizz.id/classes/update_stats', // the url where we want to POST
            data: {
