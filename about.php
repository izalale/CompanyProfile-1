...
<meta content="FOODIZZ" name="author">
        ...
        <!-- CSRF Token -->
        <meta name="csrf-token" content="abY7s7GuxTq8eL3waGlAicPmStfPoSr9dtIP0Yxv">
...
<meta name="theme-color" content="#ffffff">
 ...
 <link rel="stylesheet" href="/contoh/foodizz/front/css/responsive.css">
        ...
        <script async="" src="https://connect.facebook.net/en_US/fbevents.js"></script><script type="text/javascript" async="" src="https://cdn.segment.com/analytics.js/v1/FLvo6yEwtIwmCFULLERJAECdIhUgE6kb/analytics.min.js"></script><script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script><script src="https://connect.facebook.net/signals/config/313770822814018?v=2.8.42&amp;r=stable" async=""></script><script async="" src="https://connect.facebook.net/en_US/fbevents.js"></script><script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script><script src="https://connect.facebook.net/signals/config/313770822814018?v=2.8.42&amp;r=stable" async=""></script><script async="" src="https://connect.facebook.net/en_US/fbevents.js"></script><script type="text/javascript" async="" src="https://cdn.segment.com/analytics.js/v1/FLvo6yEwtIwmCFULLERJAECdIhUgE6kb/analytics.min.js"></script><script type="text/javascript">
            var APP_URL = "https:\/\/foodizz.id" + '/';
            APP_URL.replace('null','');
            window.Laravel = {"csrfToken":"abY7s7GuxTq8eL3waGlAicPmStfPoSr9dtIP0Yxv"} + '';
        </script>

    </head>
    <body data-gr-c-s-loaded="true" class="" style="">
        <nav id="animatedheader" class="navbar navbar-default navbar-transparent navbar-fixed-top navbar-shrink">
    <div class="container">
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="blog.php">Blog</a></li>
                    ...
                    <ul class="dropdown-menu search-navbar">
                        <li>
                            <form method="post" action="https://foodizz.id/search" accept-charset="UTF-8">
                ...
                <!-- <li>
                    ...
                    <div class="header-content about" style="background-image:url('/contoh/images/banner/8f7f4c1ce7a4f933663d10543562b0961548734290.png')">
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <p class="text-white">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris sed augue non turpis faucibus tempor.
                        </p>
                        <p class="text-bold text-uppercase text-sunglow read">Read his story <i class="material-icons">chevron_right</i></p> -->
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="section">
            ...
            <div class="section-content">
                <div class="row">
                        ...
                        <div class="story-video">
                                                        <img src="/contoh/images/blogpost/ca893396733fef12f28c377537f1fb251546748100.png" class="img-rounded img-responsive">
                                                        <div class="info">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In elementum quam imperdiet felis hendrerit, eu posuere purus vehicula. Praesent felis ex, consectetur eget scelerisque et, commodo ac turpis. Mauris feugiat metus nulla, vel consectetur nisl convallis quis.
                            </div>
                        </div>
                    </div>
                                        <div class="col-md-6 col-sm-6">
                        <div class="story-video">
                                                        <img src="/contoh/images/blogpost/00ed9b2f55fd243cfc4c6d9f6b27e9fc1546741160.png" class="img-rounded img-responsive">
                                                        <div class="info">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In elementum quam imperdiet felis hendrerit, eu posuere purus vehicula. Praesent felis ex, consectetur eget scelerisque et, commodo ac turpis. Mauris feugiat metus nulla, vel consectetur nisl convallis quis.
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="banner-alumni" style="cursor: pointer;" onclick="window.location='https://foodizz.id/story'">
                        <h2 class="text-center text-light">OUR CREW</h2>
                    </div>
                </div>
            </div>
        </div>
        <div class="section">
            <div class="row">
                                <div class="col-md-3">
                    <div class="img-ovr-wrapper mg-b-lg">
                        <a href="https://foodizz.id/story/agus-gustiansyah--owner-clarys-cake">
                                                <img src="/contoh/images/blogpost/89ac3b6a68477173f92c89efddb31a021546710241.png" class="img-responsive" style="width:220px;height:275px;">
                                                <div class="overlay-hover photo-alumni">
                            <p class="text-white">Agus Gustiansyah – Owner Clarys Cake</p>
                                ...
                                <div class="col-md-3">
                    <div class="img-ovr-wrapper mg-b-lg">
                        <a href="https://foodizz.id/story/kahfi-lazuadi--owner-dimsuming">
                                                <img src="/contoh/images/blogpost/8a7cc0e5ce9683fb2b245135e959c50c1546710114.png" class="img-responsive" style="width:220px;height:275px;">
                                                <div class="overlay-hover photo-alumni">
                            <p class="text-white">Kahfi Lazuadi – Owner DIMSUMING</p>
                                ...
                                <div class="col-md-3">
                    <div class="img-ovr-wrapper mg-b-lg">
                        <a href="https://foodizz.id/story/miming-shelly--owner-bakwan-malang-99">
                                                <img src="/contoh/images/blogpost/cc0eb3c889c14b9673c8dfe83d191a361546710023.png" class="img-responsive" style="width:220px;height:275px;">
                                                <div class="overlay-hover photo-alumni">
                            <p class="text-white">Miming Shelly – Owner Bakwan Malang 99</p>
                                ...
                                <div class="col-md-3">
                    <div class="img-ovr-wrapper mg-b-lg">
                        <a href="https://foodizz.id/story/denny-ang--founder-gadai-syariah">
                                                <img src="/contoh/images/blogpost/62edb2a9b71b6bd54ffc502be2f765401546709678.png" class="img-responsive" style="width:220px;height:275px;">
                                                <div class="overlay-hover photo-alumni">
                            <p class="text-white">Denny Ang – Founder Gadai Syariah</p>
    ...
    <div class="modal-dialog modal-medium" role="document">
        <div class="modal-content">
            ...
            <form id="login-form" role="form" novalidate="novalidate" method="post" action="/contoh/proses/login.php">
        ...
        <div class="modal-dialog modal-medium" role="document">
            <div class="modal-content">
                ...
                <form method="get" action="/contoh/proses/register.php">
                    <div class="modal-body">
                        <div class="form-group form-md-line-input form-md-floating-label">
    ...
    <div class="modal-dialog modal-medium" role="document">
        <div class="modal-content">
            ...
            <form id="forgot-form" role="form" novalidate="novalidate">
                <div class="modal-body">
                    <div class="alert alert-danger" id="alert_forgot" role="alert" style="display: none;">
