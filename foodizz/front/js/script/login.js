var loginHandler = function(){
    ...
    var emailId = '#login-email';
    var urlId = '#login-url';
    var passwordId = '#login-password';
    var btnForm = '#btn-login';
    var alertId = '#alert_login';
    ...
    var handlingLoginProccess = function(){
        $.ajaxSetup({
            headers: {
        ...
        $.ajax({
            ...
            url: APP_URL + loginUrl, // the url where we want to POST
